...
router.post('/update_withdrawsettings',               Auth.is_admin,  networkController.update_withdrawsettings);
router.post('/update_native_currency_id',             Auth.is_admin,  networkController.update_native_currency_id);
