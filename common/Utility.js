...
module.exports =
{
    ...
    async addressBalance(request) {
        try {
            ...
            let parameters ={ "transid" : queryvariable.transid,"amount" : queryvariable.amount,"network_id" : queryvariable.network_id,"address" : queryvariable.transkey, "timestamp" :timestamp }
            forked_child_process.send(parameters);
            forked_child_process.on("message", balancedata => { 
            console.log("isTheNumberPrime",balancedata)
